...
(function() {
  ...
  exports.merge = function(lines1, lines2) {
    var d, duplicates, exists, has_new_parts, i, index, index_, j, k, l, len, len1, len2, len3, len4, line1, line2, line2_, m, merged, n, part, r, ref, ref1, warnings;
    warnings = [];
    duplicates = {};
    merged = lines1;
      ...
      for (k = 0, len2 = merged.length; k < len2; k++) {
        ...
        if (line1.reference === line2.reference) {
          ...
          for (m = 0, len4 = ref1.length; m < len4; m++) {
            part = ref1[m];
            if (indexOf.call(line1.partNumbers, part) < 0) {
              has_new_parts = true;
