...
(function() {
  var checkValidLines, field_list, getOrder, hasNamedColumns, headings, lookup, parseNamed, parseSimple, parseTSV, ref, retailer_aliases, retailer_list, stripQuotes;
  ...
  parseNamed = function(rows, order, retailers) {
    ...
    for (i = j = 0, len = rows.length; j < len; i = ++j) {
      ...
      if (row !== '') {
        ...
        parts = function() {
          var field, index, len1, len2, m, manufacturer, n, part, part_indexes, part_list, ref1;
          part_list = [];
          part_indexes = [];
          ...
          if (part_list.length === 1) {
            manufacturer = (ref1 = cells[order.indexOf('manufacturer')]) != null ? ref1.trim() : void 0;
  ...
  parseTSV = function(text) {
    ...
    if (hasNamedColumns(firstCells)) {
      ...
      warnings.push({
        ...
        message: "This format will be phased out by version 1.0 but please inform us if you do rely on it."
      });
    }
