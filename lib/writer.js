...
exports.writeTSV = function (lines) {
    ...
    if (maxParts >= 1) {
        ...
        try {
            for (var _iterator = __range__(1, maxParts, true)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                var _ = _step.value;
    ...
    try {
        for (var _iterator3 = lines[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
            ...
            if (maxParts >= 1) {
                ...
                try {
                    for (var _iterator4 = __range__(0, maxParts - 1, true)[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                        var i = _step4.value;
            ...
            try {
                for (var _iterator5 = retailer_list[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
                    retailer = _step5.value;
